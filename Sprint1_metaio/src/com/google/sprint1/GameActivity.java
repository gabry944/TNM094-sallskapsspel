...
public class GameActivity extends ARViewActivity {
	...
	protected void loadContents() {
		try {
			...
			geometryProperties(antGeometry, 10f, new Vector3d(-100.0f, 100.0f,
					0.0f), new Rotation((float) (3 * Math.PI / 2), 0f, 0f));

			// create a sphere Geometry
			sphereGeometry = Load3Dmodel("sphere/sphere_10mm.obj");
			geometryProperties(sphereGeometry, 2f, new Vector3d(100.0f, 0.0f,
					0.0f), new Rotation(0.0f, 0.0f, 0.1f));

			flowerGeometry = Load3Dmodel("plumBlossom/plum blossom in glass cup_fbx.zip");
			geometryProperties(flowerGeometry, 0.08f, new Vector3d(0.0f, 0.0f,
					200.0f), new Rotation(0.0f, 0.0f, 0.1f));
	...
	public IGeometry geometryProperties(IGeometry geometry, float scale,
	...
	public void onDrawFrame() {
		...
		if (sphereGeometry == null || flowerGeometry == null
				|| flowerGeometry == null)
			return;
		...
		sphereGeometry.setTranslation(new Vector3d(SphereMoveX, 0.0f, 0.0f),
				true);
